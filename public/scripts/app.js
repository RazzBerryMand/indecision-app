...
var Traveller = (function (_Person2) {
  ...
  function Traveller(name, age, homeLocation) {
    ...
    var _this2 = _possibleConstructorReturn(
      this,
      (Traveller.__proto__ || Object.getPrototypeOf(Traveller)).call(
        this,
        name,
        age
      )
  ...
  _createClass(Traveller, [
    ...
    },
    {
      ...
      value: function getGreeting() {
        var greeting = _get(
          Traveller.prototype.__proto__ ||
            Object.getPrototypeOf(Traveller.prototype),
          "getGreeting",
          this
        ).call(this);
...
// const me = new Student ("Mand Cashin", 33, "Fine Art");
// console.log(me.getDescription());

// const other = new Student ();
// console.log(other.getDescription());

var me = new Traveller("Mand Cashin", 33, "Manchester");
